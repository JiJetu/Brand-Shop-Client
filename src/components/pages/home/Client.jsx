const Client = () => {
    return (
        <div className="container mx-auto">
            <h2 className="text-5xl font-bold text-center my-4 md:my-9 text-black dark:text-white">Our happy clients</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center p-7">
                <div className="mb-5 sm:mb-0">
                    ...
                    <h5 className="mb-3 dark:text-white">Anna Deynah</h5>
                ...
                <div className="hidden lg:block">
                    ...
                    <h5 className="mb-3 dark:text-white">John Doe</h5>
                ...
                <div className="hidden lg:block">
                    ...
                    <h5 className="mb-3 dark:text-white">Maria Kate</h5>
